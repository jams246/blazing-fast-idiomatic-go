...
Welcome to the **Blazing Fast Idiomatic Go App** - the most **blazing fast** and **idiomatic** way to discover other **blazing fast** and **idiomatic** apps in today’s **blazing fast idiomatic** landscape of **blazing fast** app creation.
...
```bash
git clone git@github.com:jams246/blazing-fast-idiomatic-go.git
cd blazing-fast-idiomatic-go
```
...
```bash
go build -o blazing-fast-idiomatic-go
```
